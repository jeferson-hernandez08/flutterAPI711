  ...
  isScrollControlled: true,  
    builder: (context) {
      return Scaffold(
        ...
        appBar: AppBar(
          title: Text('Confirmar Eliminación del evento'),
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        Text(
                          'Capacidad: ${itemList['maxCapacity'] ?? 'N/A'} personas',
                          style: TextStyle(
                            fontSize: 14,
                            color: Colors.grey[600],
                          ),
                          ...
                          children: [
                            ...
                            Expanded(
                              child: ElevatedButton(
                                onPressed: () async {
                                  try {
                                    // Lógica para eliminar el evento | Llamamos la función API apiBienestar.dart
                                    await deleteEventApi(itemList['id']);  
                                    ...
                                    Get.snackbar(
                                      'Error',
                                      'Error al eliminar evento: ${e.toString()}',
                                      backgroundColor: Colors.red,
                                      colorText: Colors.white,
                                    );
                                  }
