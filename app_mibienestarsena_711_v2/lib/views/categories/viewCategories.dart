...
import 'package:app_mibienestarsena_711_v2/views/categories/viewDeleteCategory.dart';
import 'package:app_mibienestarsena_711_v2/views/categories/viewItemCategory.dart';
          ...
          itemBuilder: (BuildContext context, int index) {
            ...
            return Card(
              child: ListTile(
                ...
                subtitle: Text(itemList['description'] ?? 'Sin descripción'),
                trailing: Row(
