...
const rol_controller = require('../../controllers/rolController');   // Importamos el controlador de rols

router.get('/testRolApi', rol_controller.testRolAPI); // Ruta para probar la API de rols
