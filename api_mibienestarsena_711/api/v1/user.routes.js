...
const user_controller = require('../../controllers/userController');   // Importamos el controlador de users

router.get('/testUserApi', user_controller.testUserAPI); // Ruta para probar la API de users
